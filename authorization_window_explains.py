...
class AuthorizationWindow:
    def __init__(self, root):
        ...
        # СОЗДАЕМ ПАПКУ ДЛЯ ДАННЫХ В ПАПКЕ С ПРОГРАММОЙ
    ...
    def setup_data_folder(self):
        ...
        # Путь к файлу users.json внутри папки data
    ...
    def create_auth_interface(self):
        ...
        # Показываем путь к файлу (для отладки)
    ...
    def register(self):
        ...
        if self.save_users():
            ...
            # Если сохранение не удалось, удаляем пользователя из памяти
